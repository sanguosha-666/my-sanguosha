...
>
> - **历史改动的完整记录在 `docs/progress-log-*.md`**（按时间顺序分段，当前共 11 段，
>   `docs/progress-log-1.md` 最早、`docs/progress-log-11.md` 最新）。如果需要了解某个
...
> 1. 打开 `docs/` 目录下编号最大的 `progress-log-N.md`（目前是 `progress-log-11.md`）。
