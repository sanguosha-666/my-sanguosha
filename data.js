...
const GENERALS = {
  ...
  sunce:         { id:'sunce',         name:'孙策',   gender:'male', faction:'wu', maxHp:4, skill:'激昂/魂姿/制霸',
    desc:'激昂:当你使用【决斗】或红色【杀】指定目标后,或成为【决斗】或红色【杀】的目标后,你可以摸一张牌。魂姿:觉醒技,准备阶段,若你的体力值为1,你减1点体力上限,然后获得【英姿】和【英魂】。英姿:锁定技,摸牌阶段你额外摸一张牌。英魂:准备阶段,若你已损失体力,你可以选择一名其他角色,然后你选择：令其摸X张牌,然后弃置1张牌;或摸1张牌,然后弃置X张牌。X为你已损失的体力值。制霸:主公技,其他吴势力角色的出牌阶段限一次,其可以与你拼点;若你已发动【魂姿】,你可以拒绝此拼点。其没赢后,你获得双方拼点的牌。',
